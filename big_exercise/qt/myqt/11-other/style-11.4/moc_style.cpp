...
**
** Created: Sun Sep 11 10:40:02 2011
...
static const char qt_meta_stringdata_Style[] = {
    "Style\0\0slotChangeStyle(QString)\0"
};

const QMetaObject Style::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Style,
      qt_meta_data_Style, 0 }
};
...
int Style::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: slotChangeStyle((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
